...
$data_header = array('title' => HOUSEKEEPING.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/housekeeping.php',$data_content);
