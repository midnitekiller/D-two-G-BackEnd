...
$data_header = array('title' => EDITRESTAURANT.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-restaurant.php',$data_content);
