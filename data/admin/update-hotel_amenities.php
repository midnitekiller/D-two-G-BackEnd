...
$data_header = array('title' => EDITAMENITIES.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-hotel_amenities.php',$data_content);
