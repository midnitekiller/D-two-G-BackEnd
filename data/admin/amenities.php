...
$amenities_lists = $Amenities_db->fetchAmenitiesAll($hotelid);
$profile_lists = $profile_db->displayProfile($_SESSION['email']);
$change_lists = $profile_db->displayProfile($_SESSION['email']);
$data_header = array('title' => AMENITIES.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid, 'amenities' => $amenities_lists);
...
$content = new Template('views/hotel-aminities.php',$data_content);
