...
<div class="row">
    <div class="col-lg-12" style="background-image:url('media/background.png');background-size:cover;height:800px;">
        <div class="col-lg-12 container">
            <div class="col-lg-2">
                <center>
                    <a href="advertiser-dashboard.php"><img src="media/home_icon.png" class="img-circle" style="height:60px;margin-top:30px;padding:0px;"></a>
                    <a href="advertiser-dashboard.php"><img id="backtoDashboard" src="media/back_icon.png" class="img-circle" style="height:60px;margin-top:30px;padding:0px;"/></a>
                </center>
            </div>
            <div class="col-lg-10" style="margin-top:20px;color:#fff;padding:0px;"><h1><b>Places Nearby</b></h1></div>
        </div>
        <div class="col-lg-1">
            <img src="media/dummy_logo.png" style="height:400px;margin-top:130px;" />
        </div>
        <div class="col-lg-11">
            <main class="weather-app">
              <ul class="days-of-the-week">
                <li id="adActivities" class="monday active">
                    <div class="image_title">
                        <a href="#">Activities</a>
                    </div> 
                </li>
                <li id="adNightlife" class="tuesday">
                    <div class="image_title">
                        <a href="#">Nightlife</a>
                    </div> 
                </li>
                <li id="adRestaurants" class="thursday">
                    <div class="image_title">
...
<script>
 $(document).ready(function(){
  $("#adActivities").click("click",function() {
	window.location.href = "advertiser-details.php?place=Activities";
  });
  
  $("#adNightlife").on("click",function() {
	window.location.href = "advertiser-details.php?place=Nightlife";
  });
  
  $("#adRestaurants").on("click",function() {
	window.location.href = "advertiser-details.php?place=Restaurants";
  });
});
