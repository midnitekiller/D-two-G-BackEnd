<?php 
      ...
      $order_lists = $order_db->fetchViewOrder($hotelid);
?>
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <label> In-Room Dining Report (Hotel Order) </label>
            </div>
                ...
                <table id="sorting_data" class="table table-bordered dynamicDataTables">
                    ...
                    <tbody>
                        ...
                        <tr class="lists-item">
                            ...
                            <td class="text-center"><?php echo $order_list['menu_name'];?></td>
                            <td class="text-center"><?php echo $order_list['quantity'];?></td>
                            <td class="text-center"><?php echo $order_list['menu_price'];?></td>
