<?php 
      ...
      $order_db = new Order();
      $order_lists = $order_db->fetchOrder($hotelid);
?>

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <div class="col-lg-9">
            <h2>GUESTS RESTAURANT ORDER DETAILS</h2>
        </div>
    </div>
</div><br/>
<div id="mssg"></div><br/>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title-table">
                <label>ALL RESTAURANT ORDERS</label>
            </div>
            <div class="ibox-content"> 
                <table id="#GuestListTable" class="table table-bordered dynamicDataTables">
                    ...
                    <tbody>
                        ...
                        <tr class="lists-item">
							<td class="text-center"><?php echo $order_list['restoorder_ID'];?></td>
                            ...
                            <td class="text-center"><?php echo $order_list['created'];?></td>
                            <td class="text-center">
                                <a href="view-order.php?id=<?php echo $order_list['restoorder_ID']; ?>" class="glyphicon glyphicon-eye-open fa-2x" data-toggle="tooltip" title="View Order" ></a>
                            </td>
                            <td class="text-center">
                                <label class="switch">
                                  <input id="<?=$order_list['restoorder_ID'];?>" type="checkbox" <?=($order_list['confirm_status'] == "active") ? "checked" : ""?> data-toggle="toggle" onclick="updateStatus(this);">
