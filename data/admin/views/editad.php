        ...
        <div class="ibox-content">
            <form method="post" enctype="multipart/form-data" id="update_places_detail_form">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="hotel_name" id="" class="form-control m-b">
                                ...
                                <?php foreach($hotels as $key => $hotel):  ?>
									<option value="<?=$hotel['hotel_ID'];?>" <?=($ad['hotel_ID'] == $hotel['hotel_ID']) ? "selected" : "";?>><?=$hotel['hotel_name'];?></option>
								<?php endforeach; ?>
                            </select>
                        </div>
                         <div class="col-sm-3">
                            ...
                            <select name="ad_category" id="" class="form-control m-b">
                                ...
                                <?php foreach($categories as $key => $cate):  ?>
									<option value="<?=$cate['adtype_ID'];?>" <?=($cate['adtype_ID'] == $ad['adtype_ID'])? "selected" : "";?>><?=$cate['adtype_name'];?></option>
								<?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <label class="control-label">Date Live from</label> <small>( required ) </small>
                             <div class='input-group input-daterange'>
                                ...
                                <input type="text" class="form-control"  name="daterange_in"  id="datetimepicker1" value="<?=date('Y-m-d',strtotime($ad['ad_time_start']));?>" />
                            </div>
                        </div>  
                        <div class="col-sm-3">
                            <label class="control-label">Date Live to</label> <small>( required ) </small>
                             <div class='input-group input-daterange'>
                                ...
                                <input type="text" class="form-control"  name="daterange_out" id="datetimepicker2" value="<?=date('Y-m-d',strtotime($ad['ad_time_end']));?>" />
                            </div>
                        </div>
                    </div>
					<div class="row"><br/>
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <button class="btn btn-info" name="action" value="Update Advertisement" type="submit">Submit</button>
                        </div>
                    </div>
                </div>
			</form>
