...
if(isset($_GET['hotel_id'])){
	$hotel = $ho->getHotelInfo($_GET['hotel_id']);
	$user = $uc->getUserInfo($_GET['hotel_id']);
}
...
$data_header = array('title' => EDITHOTEL_TITLE, 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
$data_nav = array('baseUrl' => BASE_URL, 'name' => $name, 'messages' => $messages, 'chatcount' => $count);
$data_content = array('hotel' => $hotel, 'user' => $user);
...
$content = new Template('views/hotelupdate.php', $data_content);
