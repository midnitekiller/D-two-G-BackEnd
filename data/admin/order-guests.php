...
$data_header = array('title' => RESTAURANT_ORDER.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/order-guests.php',$data_content);
