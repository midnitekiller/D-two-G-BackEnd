...
/* data and display */
$staff_lists = $staff_db->getAllStaff($_SESSION['hotel_id']);
...
$data_header = array('title' => STAFF_EXISTING.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid, 'staff_lists' => $staff_lists);
...
$content = new Template('views/viewStaff.php',$data_content);
