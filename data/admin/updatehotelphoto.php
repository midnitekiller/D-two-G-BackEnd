...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid,  'hotel' => $hotel_lists, 'hotelname' => $hotname, 'hotel_logo' => $hotel_logo);
$header = new Template('views/content-header.php', $data_header);
$nav = new Template('views/content-sidenav.php', $data_nav);
$content = new Template('views/updatehotelphoto.php',$data_content);
