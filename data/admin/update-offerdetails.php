...
$data_header = array('title' => EDITOFFERDETAIL.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-offerdetails.php',$data_content);
