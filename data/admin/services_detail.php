...
$servicesDetails_lists = $services_db->fetchServicesDetailAll($hotelid);
...
$data_header = array('title' => SERVICES_DETAIL.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid, 'services' => $servicesDetails_lists, 'services_type' => $servicesType_lists);
...
$content = new Template('views/services_detail.php',$data_content);
