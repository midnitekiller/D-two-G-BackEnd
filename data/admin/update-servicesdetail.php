...
$data_header = array('title' => EDITSERVICESDETAIL.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-servicesdetail.php',$data_content);
