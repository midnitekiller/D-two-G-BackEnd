...
foreach($hotelcontent as $i => $hot){
	$hotelcontent[$i]['unseen_count'] = $ch->getUnseenCount($hot['hotel_ID'], 'superadmin');
}
if(!isset($_GET['hotel_ID'])){
	$hotelidd = "";
}else{
	$hotelidd = $_GET['hotel_ID'];
}	
...
$data_header = array('title' => CHAT_TITLE, 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('hotels' => $hotelcontent, 'hotelidd' => $hotelidd);
...
$content = new Template('views/adminchatroom.php', $data_content);
