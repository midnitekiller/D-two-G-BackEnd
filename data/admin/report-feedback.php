...
$data_header = array('title' => $hotname.REPORT_FEEDBACK , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/report-feedback.php',$data_content);
