...
$apps = $apk->getAPKS();
$data_header = array('title' => APP_TITLE, 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('hotelss' => $hotels, 'apps' => $apps);
...
$content = new Template('views/application-update.php', $data_content);
