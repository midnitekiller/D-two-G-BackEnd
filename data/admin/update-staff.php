...
/* data and display */
$staff_ID = $_GET['id'];
$staff_lists = $staff_db->fetchStaffData($staff_ID);
...
$data_header = array('title' => EDITSTAFF.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-staff.php',$data_content);
