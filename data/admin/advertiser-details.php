...
$hotels = $ho->getHotels();
$advertisements = $ads->fetchAdvertiser($_SESSION['email']);
...
$data_content = array('hotels' => $hotels, 'adtitle' => $titleadvertiser);
...
$content = new Template('views/advertiser-details.php', $data_content);
