...
$data_header = array('title' => $hotname.REPORT_SERVICES , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/report-services.php',$data_content);
