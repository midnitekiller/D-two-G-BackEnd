...
$data_header = array('title' => $hotname.REPORT_HOTEL , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-channelad.php',$data_content);
