...
$data_header = array('title' => SERVICES_ORDER.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/view-orderService.php',$data_content);
