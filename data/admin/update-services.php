...
$data_header = array('title' => EDITSERVICES.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-services.php',$data_content);
