...
$hotels = $ho->getHotels();
$channels = $ch->getChannelInfo($_GET['channel_id']);
...
$data_header = array('title' => EDITCHANNEL_TITLE, 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('hotels' => $hotels, 'channel' => $channels);
...
$content = new Template('views/channelupdate.php', $data_content);
