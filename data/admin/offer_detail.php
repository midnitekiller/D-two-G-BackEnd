...
$data_header = array('title' => OFFER_DETAIL.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/offer_detail.php',$data_content);
