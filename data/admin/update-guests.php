...
$data_header = array('title' => EDITGUESTS.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$content = new Template('views/update-guests.php',$data_content);
