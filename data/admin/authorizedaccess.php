...
$access_lists = $ho->fetchAccessAdmin($hotelid);
$profile_lists = $profile_db->displayProfile($_SESSION['email']);
$change_lists = $profile_db->displayProfile($_SESSION['email']);
$data_header = array('title' => ACCESS.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid,  'access' => $access_lists, 'hotelname' => $hotname, 'hotel_logo' => $hotel_logo);
...
$content = new Template('views/authorizedaccess.php',$data_content);
