...
$restaurant_lists = $restaurant_db->fetchRestaurantAll($hotelid);
$profile_lists = $profile_db->displayProfile($_SESSION['email']);
$change_lists = $profile_db->displayProfile($_SESSION['email']);
$data_header = array('title' => RESTAURANT.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('baseUrl' => BASE_URL, 'name' => $name, 'hotelid' => $hotelid, 'hotelname' => $hotelname, 'restaurant' => $restaurant_lists);
...
$content = new Template('views/restaurant.php',$data_content);
