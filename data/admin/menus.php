...
$restaurants = $res->fetchRestaurantAll($hotelid);
$menus = $me->getAllMenus($hotelid);
$profile_lists = $profile_db->displayProfile($_SESSION['email']);
$change_lists = $profile_db->displayProfile($_SESSION['email']);
$data_header = array('title' => MENU.$hotname , 'keywords' => MAIN_KEYWORDS, 'description' => MAIN_DESCRIPTION);
...
$data_content = array('restaurants' => $restaurants, 'hotelid' => $hotelid, 'menus' => $menus);
...
$content = new Template('views/menus.php', $data_content);
